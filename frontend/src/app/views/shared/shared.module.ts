...
@NgModule({
  declarations: [OverViewCardsComponent,MbToGbPipe,PercentageToProgressColorPipe,RelativeTimeFilterPipe,
     CompontentsOverViewComponent,ClusterEventsComponent, DynamicFormComponent,PhaseToBadge, DeploymentListComponent, BreadcrumbComponent, LoadFromYamlFormComponent, PodListComponent],
  imports: [
    CommonModule,
    MatTableModule,
    MatPaginatorModule,
  ...
  exports: [AccordionModule,TableModule,MatTableModule,MatPaginatorModule,MatDialogModule,ReactiveFormsModule, 
    ...
    ToolbarModule,ConfirmDialogModule,DropdownModule,MatMenuModule,MatButtonModule,MatIconModule,PodListComponent,MultiSelectModule,FormsModule,MatCheckboxModule],
